	...
	<el-dialog title="首页banner编辑" :visible.sync="dialogFormVisible">
		<el-form :model="editFrom" ref="advertform">
			<el-form-item label="图片路径" :label-width="formLabelWidth">
				<el-col width='400'>
					<img :src="editFrom.img" mode='widthFix' style="width:100%"  @click="ImgClick">
				</el-col>
			...
			<el-form-item label="是否关联商品" :label-width="formLabelWidth" prop="isconnect">
				<el-radio-group v-model="editFrom.isconnect">
					<el-radio :label="1">是</el-radio>
					<el-radio :label="0">否</el-radio>
				</el-radio-group>
			</el-form-item>
			<el-form-item label="关联商品Id" :label-width="formLabelWidth" prop="associationGoods" v-if="editFrom.isconnect == 1" >
				<div class="inputGoods">
					<el-input v-model="editFrom.associationGoods" autocomplete="off" ></el-input>
