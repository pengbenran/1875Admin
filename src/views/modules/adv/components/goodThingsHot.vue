<template>
    ...
    <el-col :span="24" class="warp-main">
      ...
      <!-- 新增模态框 -->
      <goodThingsHotAddDialog :addFrom='addFrom' ref="goodThingsHotAddDialog"></goodThingsHotAddDialog>
      <!-- 编辑模态框 -->
      <goodThingsHotEditDialog :editFrom='editFrom' ref="goodThingsHotEditDialog"></goodThingsHotEditDialog>
      <!-- 图片裁剪 -->
...
<script>
  ...
  export default {
    data () {
      return {
       ...
       gridData: [{
        ...
        {kindId:3,kindName:'女神范儿',img:'/static/img/hot1bg.jpg',kindNameColor:'#322E2E',gridData: [{
          date: '2016-05-02',
          name: '王小虎',
          address: '上海市普陀区金沙江路 1518 弄'
        }, {
    ...
    components: { cropper,goodThingsHotAddDialog,goodThingsHotEditDialog},
    methods: {
          //编辑
