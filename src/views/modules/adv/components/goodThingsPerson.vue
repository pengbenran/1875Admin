<template>
    ...
    <el-col :span="24" class="warp-main">
      ...
      <!-- 添加界面 -->
      <goodThingsPersonAddDialog :addFrom='addFrom' ref="goodThingsPersonAddDialog" @ImgClick="ImgClick"></goodThingsPersonAddDialog>
      <!-- 编辑界面 -->
      <goodThingsPersonEditDialog :editFrom='editFrom' ref="goodThingsPersonEditDialog" @ImgClick="ImgClick"></goodThingsPersonEditDialog>
      <!-- 关联商品 -->
