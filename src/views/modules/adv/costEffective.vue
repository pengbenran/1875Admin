<template>
    ...
    <el-col :span="24" class="warp-main">
      ...
      <!-- 添加界面 -->
      <costEffectiveAddDialog :addFrom='addFrom' ref="costEffectiveAddDialog" @ImgClick="ImgClick"></costEffectiveAddDialog>
      <!-- 编辑界面 -->
      <costEffectiveEditDialog :editFrom='editFrom' ref="costEffectiveEditDialog" @ImgClick="ImgClick"></costEffectiveEditDialog>
      <!-- 关联商品 -->
